...
//
	  ...
	  $rs_results_payments = mysql_query($sql_payments) or die(mysql_error());
...
//update
list($last_payment) = mysql_fetch_row(mysql_query("select paid from orders where order_no = '$the_order_no' and assigned_to='$writers_id'"));	
$paid_thus_far =$last_payment + $pay_amnt;
mysql_query("Update`orders` set `status`='Paid', `paid`='$paid_thus_far' where order_no = '$the_order_no' and assigned_to='$writers_id'") or die(mysql_error());
...
<table width="100%" border="0">
  <tr valign="top">
    <td><div  style=" float:left;" class="titlehdr">Select writer for payment:</div></td>
...
<tr>
  ...
  <tr>
    <td colspan="6"> <strong>Select writer to pay: </strong>
...
<br>
       ...
       <table  cellpadding="0" cellspacing="0" border="0" class="display" id="thetable">
		<thead>
          <tr>
			<th> <div align="center"><strong>Ref No</strong></div></th>
            <th> <div align="center"><strong>Writers Id </strong></div></th>
            <th><div align="center"><strong>Amount paid </strong></div></th>
            <th><div align="center"><strong>Payment date </strong></div></th>
...
<td nowrap class="order_borders" ><div align="center"> <span style="text-transform:uppercase"> <?php echo $rrows['reference_no']; ?></span> </div></td>
            ...
            <td  class="order_borders"> <div align="center"><?php echo $rrows['pay_date'];?></div></td>
            <td  class="order_borders"><div align="center"><?php echo $rrows['order_no'];?></div></td>
          </tr>
          <?php    }  ?>
		  </tbody>
        </table>
