...
@if(Auth::user()->hasRole('client'))
 ...
 <div class="uk-grid" data-uk-grid-margin>
  ...
  <div class="parsley-row">
    ...
    <input type="text" id="topic" name="topic" value="{{ old('topic') }}" data-parsley-trigger="change" class="md-input" />
     @if ($errors->has('topic'))
...
<div class="uk-width-medium-1-2">
         ...
         <select id="select_demo_2" title="Subject area" class="md-input required" name="order_category" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();" value="{{ old('order_category') }}">
...
<div class="uk-width-medium-1-2">
<div class="parsley-row">
  <label for="worktype">Type of document<span class="req">*</span></label>
  <select name="doctype_x" id="doctype_x" class="md-input required" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();">
...
@endif
  ...
  <div class="uk-width-medium-1-2">
  <div class="parsley-row">
  <label for="worktype">Number of pages/words:<span class="req">*</span></label>
 <select title="Number of pages" class="md-input required" name="numpages" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();">
...
@endif
 ...
 <div class="uk-grid" data-uk-grid-margin>
  ...
  <div class="parsley-row">
    ...
    <input  name="o_interval" id="o_interval" value="1" onClick="javascript:doOrderFormCalculation();" type="checkbox" class="md-input"> &nbsp;<b>Single spaced</b>
...
<select title="Paper urgency" class="md-input required" name="urgency" id="urgency" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();">
...
<select id="numberOfSources" name="numberOfSources" size="1" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();" class="md-input">
...
<select id="style" name="writing_style" class="md-input required" size="1" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();">
...
<select title="Academic level" class="md-input required" name="academic_level" id="academic_level" onChange="javascript:doOrderFormCalculation();" onclick="javascript:doOrderFormCalculation();">
...
<input type="hidden" name="totals" value="0" id="totals">
  <div class="uk-width-medium-1-2">
  <div class="parsley-row">
    <label for="email">Order description<span class="req">*</span></label>
    <textarea  id="details" name="details" class="md-input required" value="{{ old('details') }}"></textarea>
